-- ============================================================================
-- SmartRx AI - Schema SQL para RAG e Compliance ANVISA RDC 657/2022
-- PostgreSQL com extensões pgvector para busca semântica
-- ============================================================================
...
CREATE INDEX knowledge_base_validity_status_idx ON knowledge_base (validity_status);
CREATE INDEX knowledge_base_hospital_id_idx ON knowledge_base (hospital_id) WHERE hospital_id IS NOT NULL;
